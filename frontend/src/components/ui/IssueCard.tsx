...
const KIND_COLOR: Record<
  string,
  { border: string; bg: string; bgHover: string }
> = {
  error: {
    border: "#f87171",
    bg: "rgba(248,113,113,.04)",
    bgHover: "rgba(248,113,113,.08)",
  },
  warning: {
    border: "#f5b544",
    bg: "rgba(245,181,68,.04)",
    bgHover: "rgba(245,181,68,.08)",
  },
  safe: {
    border: "#4ade80",
    bg: "rgba(74,222,128,.04)",
    bgHover: "rgba(74,222,128,.08)",
  },
  info: {
    border: "#60a5fa",
    bg: "rgba(96,165,250,.04)",
    bgHover: "rgba(96,165,250,.08)",
  },
};
...
export function IssueCard({
  ...
  return (
    <div
      ...
      onMouseEnter={(e) => {
        if (onClick)
          (e.currentTarget as HTMLDivElement).style.background = color.bgHover;
      }}
      onMouseLeave={(e) => {
